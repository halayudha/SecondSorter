...
public class SsJob extends Configured implements Tool{
    ...
    public static class SsMapper extends Mapper<LongWritable, Text, TextDsi, IntWritable>{
        private final static IntWritable one = new IntWritable(1);
        private Text word = new Text();
        private TextDsi wordDsi;
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
            ...
            while (tokenizer.hasMoreTokens()){
                ...
                wordDsi = new TextDsi(word.toString(),key.get(),i);
    ...
    public static class SsReducer extends Reducer<TextDsi, IntWritable, Text, IntWritable>{
        @Override
        public void reduce(TextDsi key, Iterable<IntWritable> values, Context context) throws IOException, InterruptedException{
